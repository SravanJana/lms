...
<div class="main-div">
  <div class="form-container">
    <h1>update Course</h1>
    <form:form action="processEditCourse?courseID=${course.course_id}"  modelAttribute="course" method="post">
      ...
      <form:errors path="courseDuration" cssClass="error"/>
      <label>courseDescription:</label>
      <form:input path="courseDescription"/><br>
      <form:errors path="courseDescription" cssClass="error"/>
      <label>Instructor:</label>
      <form:input path="instructor.instructorName" disabled="true"/><br>
      <form:errors path="instructor.instructorName" cssClass="error"/>
