...
<div class="main-content">
    ...
    <div class="stats">
        <div class="stat-box">
            <h3><a style="text-decoration: none;color: white" href="${pageContext.request.contextPath}/courses">Courses</a></h3>
            <p>${coursesCount}</p>
        </div>
        <div class="stat-box">
            <h3>    <a style="text-decoration: none;color: white" href="${pageContext.request.contextPath}/instructor">Instructors</a></h3>
            <p>${instructorsCount}</p>
        </div>
        <div class="stat-box">
            <h3>    <a style="text-decoration: none;color: white" href="${pageContext.request.contextPath}/students"> Students</a></h3>
            <p>${usersCount}</p>
        </div>
    </div>
        ...
        <table>
            ...
            <c:forEach var="course" items="${courses}">
                <tr>
                    ...
                    <td><a class="btn-green btn-custom" href="${pageContext.request.contextPath}/courseOverview?courseId=${course.course_id}">View</a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
